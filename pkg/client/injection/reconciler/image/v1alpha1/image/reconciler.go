...
import (
	...
	versioned "github.com/imjasonh/image/pkg/client/clientset/versioned"
	imagev1alpha1 "github.com/imjasonh/image/pkg/client/listers/image/v1alpha1"
	zap "go.uber.org/zap"
...
type reconcilerImpl struct {
	...
	Lister imagev1alpha1.ImageLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister imagev1alpha1.ImageLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.Image, desired *v1alpha1.Image) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.ImageV1alpha1().Images(desired.Namespace)
		...
		updater := r.Client.ImageV1alpha1().Images(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Image) (*v1alpha1.Image, error) {
	...
	patcher := r.Client.ImageV1alpha1().Images(resource.Namespace)
