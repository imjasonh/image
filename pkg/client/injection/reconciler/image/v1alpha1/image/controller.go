...
import (
	...
	versionedscheme "github.com/imjasonh/image/pkg/client/clientset/versioned/scheme"
	client "github.com/imjasonh/image/pkg/client/injection/client"
	image "github.com/imjasonh/image/pkg/client/injection/informers/image/v1alpha1/image"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "images.image.example.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "image.example.dev.Image"),
	)
